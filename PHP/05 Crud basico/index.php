...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles.css"><!-- hojas de estlilo importado-->
</head>
<body>
	<div id="wrapper">
		...
		<table>
			...
			?>
				...
				?>
					<tr>
						<td width="15%" class="text-center"><?php echo $user['id']; ?></td>
						<td width="15%"><a href="read.php?id=<?php echo $user['id'] ?>"><?php echo $user['name']; ?></a></td>
